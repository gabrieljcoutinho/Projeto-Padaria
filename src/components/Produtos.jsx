...
const Produtos = () => {
  // Lista de produtos para evitar repetição de HTML
  const listaProdutos = [
    { id: 1, nome: "Whole Grain Bread", preco: "$40", img: produt1 },
    { id: 2, nome: "Whole Grain Bread", preco: "$40", img: produt2 },
    { id: 3, nome: "Whole Grain Bread", preco: "$40", img: produt3 },
    { id: 4, nome: "Whole Grain Bread", preco: "$40", img: produt4 },
    { id: 5, nome: "Whole Grain Bread", preco: "$40", img: produt5 },
    { id: 6, nome: "Whole Grain Bread", preco: "$40", img: produt6 },
  ];
      ...
      <div className="flexbox">
        {listaProdutos.map((produto) => (
          <div className="cardProduto" key={produto.id}>
            <img src={produto.img} alt={produto.nome} className="imgProduct" />
